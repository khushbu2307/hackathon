          ...
          <div className="flex justify-between items-center h-14">
            ...
            <div className="flex items-center space-x-6">
              <Link to="/" className="flex items-center space-x-2">
                ...
                <span className="text-lg font-semibold text-foreground">StackIt</span>
              </Link>
            ...
            <div className="hidden md:flex flex-1 max-w-md mx-8 items-center space-x-3">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="start" className="bg-popover border-border">
                  <DropdownMenuItem className="hover:bg-accent">Newest</DropdownMenuItem>
                  <DropdownMenuItem className="hover:bg-accent">Unanswered</DropdownMenuItem>
                  <DropdownMenuItem className="hover:bg-accent">Popular</DropdownMenuItem>
                  <DropdownMenuItem className="hover:bg-accent">Trending</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button
                ...
                size="sm"
                className="btn-professional hidden sm:flex"
              >
